(function(factory) {
    ...
    Calendar.prototype.init = function() {
        ...
        for (var i = 0; i < aCalendars.length; i++) {
            ...
            aCalendars[i].addEventListener('focus', function focus() {
                ...
                var prev, now, next, oDate = new Date(new Date().getTime()-1000*60*60*24);
    ...
    Calendar.prototype.createCalenList = function(data, setTitle) {
        ...
        for (var i = 0; i < dSun; i++) {
            ...
            var dayEle = create('a', {
                ...
                day);
            var oDate = new Date(new Date().getTime()-1000*60*60*24);
    ...
    Calendar.prototype.createDate = function(data, callback) {
        ...
        var length = 0;
        var now = 0;
        var nowY = (new Date(new Date().getTime()-1000*60*60*24)).getFullYear();
