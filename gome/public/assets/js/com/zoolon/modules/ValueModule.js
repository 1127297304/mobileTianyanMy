...
App.ValueModule = function(size) {
	...
	this.getPreloadAssets = function() {
		return [{
			type: "html",
			url: "assets/data/modules/value.html"
		}];
	}
...
//		},5000)
		...
		setInterval(function(){
			...
			$.ajax({
				...
				type: 'get',
				success: (data)=>{
					//console.log("地图城市"+data.data.length);
					...
					var cityGome = ['合肥市', '蚌埠市', '淮南市', '淮北市', '滁州市', '安庆市', '马鞍山市', '阜阳市', '芜湖市', '六安市', '铜陵市', '北京市', '惠州市', '佛山市',
						...
						'晋城市', '阳泉市', '西安市', '上海市', '德阳市', '成都市', '凉山自治州', '达州市', '内江市', '巴中市', '泸州市', '攀枝花市', '南充市', '自贡市', '雅安市', '宜宾市', '资阳市',
						'乐山市', '绵阳市', '广元市', '广安市', '眉山市', '凉山彝族自治州', '天津市', '昆明市', '宁波市', '杭州市', '温州市',
