...
App.SalesController2 = function(option)
{
	debugger
	var self = this;
	...
	console.log(chart)
	var lightView1 = $("<div>",{style:"width:80px;height:250px;position:absolute;background:url(assets/images/goods/light.png);top:0px;"});
	var paper1 = Raphael(chart.get(0),chart.width(),chart.height());
	...
	for(var i=0;i<len;i++)
	{
		...
		var circle = paper.circle(tx, ty, i == lightIdx ? 30 : 15);
		circle.attr("stroke", i == lightIdx ? "#61C5D6" : "#C7C8CC");
		circle.attr("stroke-width", i == lightIdx ? 3 : 2);
	...
	for(var i=0;i<len;i++)
	{
		...
		circle.attr("fill", i == lightIdx ? "#61C5D6" : "#C7C8CC");
		...
		label.css("color",i == lightIdx ? "#61C5D6" : "#C7C8CC");
		label.width(82);
	...
	this.setDataSource1 = function(ds)
	{
		return '111'
