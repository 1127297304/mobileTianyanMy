	...
	//var timer2 = null;
		...
		function askSumData(){
			...
			$.ajax({//总交易金额、件数
				...
				url:"http://10.143.107.219:8001/activity/jinkong/getLoanInfo.gm",
	    		type:"get",
	    		dataType:"json",
	    		success:function(e){
		...
		askSumData();
	 	...
	 	function askForPieMylc(){
			$.ajax({//理财投资金额
				...
				//url:"./circle1.json",
				url:"http://10.143.113.15:9080/app/meiYiFinancing/getDataFromDashUserAccumuActiveTableOfOtherDay.gm?index=tzje",
			 	type:"get",
			 	dataType:"json",
				cache:'false',
			 	success:function(data){
					//console.log(data);
			 		scale_occupy(data.data.datainfo);
			 	},
			 	error:function(){
			 		console.log("请求失败");
			 	}
	 	...
	 	function askForPie(){
			$.ajax({//美易分大区占比
			 	//url:"http://10.129.223.172:8080/app/daping/getAreaRateOfLoan.gm",
				//url:"./circle1.json",
				url:"http://10.143.107.219:8001/external-interface/mfy/monitor/getLoanAreaRatio.gm",
			 	type:"get",
			 	dataType:"json",
				cache:'false',
			 	success:function(data){
					//console.log(data);
			 		scale_occupyMyf(data.data);
			 	},
			 	error:function(){
			 		console.log("请求失败");
			 	}
		...
		function scale_occupyMyf(data){//美易分饼图
			...
			var option = {
			    backgroundColor: '',
				color:['#162D87' ,'#076FB7',' #E95514','#FFEF4F','pink'],
			    title: {
			        left: 'center',
			        top: 20,
			        textStyle: {
		...
		function scale_occupy(data){//饼图
	 	...
	 	function askForLineMjData(){
	 		$.ajax({//美借放款金额
			 	//url:"http://10.129.223.172:8080/app/daping/getRealTimeTotalLoanAmountForTrend.gm",
				//url:"./zzt.json",
				url:"http://10.143.107.219:8001/activity/meijie/getMeiJieRealTimeRiskTrendModel.gm",
			 	type:"get",
			 	dataType:"json",
			 	success:function(e){
					//console.log(e)
	 	...
	 	function askForLineMjDataArea(){
	 		$.ajax({//美借热力分布
			 	//url:"http://10.129.223.172:8080/app/daping/getRealTimeTotalLoanAmountForTrend.gm",
				//url:"./zzt.json",
				url:"http://10.143.107.219:8001/activity/jinkong/mfbWebLoanInfo.gm",
			 	type:"get",
			 	dataType:"json",
			 	success:function(e){
					//console.log(e)
			 		...
			 		areaChart(lineData);
			 		$(".intMoney").text(lineData.amountList[0])
			 		$(".intPieces").text(lineData.numList[0])
			 		$(".dqMoney").text(lineData.amountList[1])
			 		$(".dqPieces").text(lineData.numList[1])
			 		$(".hzMoney").text(lineData.amountList[2])
			 		$(".hzPieces").text(lineData.numList[2])
			 	},
			 	error:function(){
			 		console.log("请求失败");
			 	}
